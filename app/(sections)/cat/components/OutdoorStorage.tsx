...
import { getOutdoorStorage } from "@/lib/firestore/folder/outdoorStorage";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function OutdoorStorage() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getOutdoorStorage()) as TProduct[];
