...
import { getChestsOfDrawersDrawerUnits } from "@/lib/firestore/folder/chestsOfDrawersDrawerUnits";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function ChestsOfDrawersDrawerUnits() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getChestsOfDrawersDrawerUnits()) as TProduct[];
  ...
  return (
    <div className="mx-12 mb-12">
      ...
      <h2 className="mt-20 border-b pb-6 text-2xl" id="products">
        Chests of drawers & bedside tables Products
      </h2>
...
export default ChestsOfDrawersDrawerUnits;
