...
import { getSideboardsBuffetsConsoleTables } from "@/lib/firestore/folder/sideboardsBuffetsConsoleTables";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function SideboardsBuffetsConsoleTables() {
  ...
  useEffect(() => {
    async function fetch() {
      const products =
        (await getSideboardsBuffetsConsoleTables()) as TProduct[];
  ...
  return (
    <div className="mx-12 mb-12">
      ...
      <h2 className="mt-20 border-b pb-6 text-2xl" id="products">
        Sideboards Buffets & Console Tables Products
      </h2>
...
export default SideboardsBuffetsConsoleTables;
