...
import { getConferenceChairs } from "@/lib/firestore/folder/conferenceChairs";
import { TProduct } from "@/types/product/product";
import { useEffect, useState } from "react";

function ConferenceChairs() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getConferenceChairs()) as TProduct[];
