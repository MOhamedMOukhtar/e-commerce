...
import { getConferenceTables } from "@/lib/firestore/folder/conferenceTables";
import { TProduct } from "@/types/product/product";
import { useEffect, useState } from "react";

function BekantConferenceMeetingTables() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getConferenceTables()) as TProduct[];
...
export default BekantConferenceMeetingTables;
