...
import { getDeskChairSets } from "@/lib/firestore/folder/deskChairSets";
import { TProduct } from "@/types/product/product";
import { useEffect, useState } from "react";

function DeskChairSets() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getDeskChairSets()) as TProduct[];
