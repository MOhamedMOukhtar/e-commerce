...
import { getConferenceTableChairSets } from "@/lib/firestore/folder/conferenceTableChairSets";
import { TProduct } from "@/types/product/product";
import { useEffect, useState } from "react";

function ConferenceTableChairSets() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getConferenceTableChairSets()) as TProduct[];
  ...
  return (
    <div className="mx-12 mb-12">
      ...
      <h2 className="mt-20 border-b pb-6 text-2xl" id="products">
        Conference table & chair sets Products
      </h2>
...
export default ConferenceTableChairSets;
