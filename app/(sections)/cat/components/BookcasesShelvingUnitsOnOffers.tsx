...
function BookcasesShelvingUnitsOnOffers() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getBookcasesShelvingUnits(true)) as TProduct[];
  ...
  return (
    <div className="mx-12 mb-12">
      <h1 className="font-mix-blend-color-dodge mt-14 mb-10 text-4xl">
        Bookcases & shelving units on offer
      </h1>
...
export default BookcasesShelvingUnitsOnOffers;
