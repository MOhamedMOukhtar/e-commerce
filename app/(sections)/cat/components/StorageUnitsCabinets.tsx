...
import { getStorageUnitsCabinets } from "@/lib/firestore/folder/storageUnitsCabinets";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function StorageUnitsCabinets() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getStorageUnitsCabinets()) as TProduct[];
  ...
  return (
    <div className="mx-12 mb-12">
      ...
      <h2 className="mt-20 border-b pb-6 text-2xl" id="products">
        Storage Units Cabinets Products
      </h2>
...
export default StorageUnitsCabinets;
