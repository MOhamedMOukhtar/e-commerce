...
import { getShoeCabinets } from "@/lib/firestore/folder/shoeCabinets";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function ShoeCabinets() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getShoeCabinets()) as TProduct[];
