...
import { getTrendingSeason } from "@/lib/firestore/folder/trendingSeason";
...
function TrendingSeason() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getTrendingSeason()) as TProduct[];
  ...
  return (
    <div className="mx-12 mb-12">
      ...
      <p className="max-w-60/100 text-sm leading-5 text-[#484848]">
        Be ready for the new chapter in the school & set up your room
      </p>
