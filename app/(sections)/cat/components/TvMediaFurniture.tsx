...
import { getTvMediaFurniture } from "@/lib/firestore/folder/tvMediaFurniture";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function TvMediaFurniture() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getTvMediaFurniture()) as TProduct[];
...
export default TvMediaFurniture;
