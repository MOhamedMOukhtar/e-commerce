...
import { getSmallFurnitureValueForMoney } from "@/lib/firestore/folder/smallFurnitureValueForMoney";
...
function ValueForMoney() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getSmallFurnitureValueForMoney()) as TProduct[];
