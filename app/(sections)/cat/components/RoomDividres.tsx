...
import { getRoomDividers } from "@/lib/firestore/folder/roomDividers";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function RoomDividres() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getRoomDividers()) as TProduct[];
