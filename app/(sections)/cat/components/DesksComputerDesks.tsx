...
import { getDesksComputerDesks } from "@/lib/firestore/folder/desksComputerDesks";
import { TProduct } from "@/types/product/product";
import { useEffect, useState } from "react";

function DesksComputerDesks() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getDesksComputerDesks()) as TProduct[];
...
export default DesksComputerDesks;
