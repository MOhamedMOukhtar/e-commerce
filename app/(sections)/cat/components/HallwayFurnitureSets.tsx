...
import { getHallwayFurnitureSets } from "@/lib/firestore/folder/hallwayFurnitureSets";
import { TProduct } from "@/types/product/product";
import React, { useEffect, useState } from "react";

function HallwayFurnitureSets() {
  ...
  useEffect(() => {
    async function fetch() {
      const products = (await getHallwayFurnitureSets()) as TProduct[];
...
export default HallwayFurnitureSets;
